...
def test_get_recent_followup_queryset(mocker):
    ...
    expected = [
        {'id': user1.id, 'first_name': user1.first_name, 'social_profiles__slack_team_id': soc_prof1.slack_team_id, 'social_profiles__slack_id': soc_prof1.slack_id, 'user_chats__penny_chat__id': user1.id, 'user_chats__penny_chat__date': penny_chat1.date, 'user_chats__penny_chat__title': penny_chat1.title, 'user_chats__penny_chat__follow_ups__user_id': user2.id, 'user_chats__penny_chat__follow_ups__user__first_name': user2.first_name},  # noqa
        {'id': user2.id, 'first_name': user2.first_name, 'social_profiles__slack_team_id': soc_prof2.slack_team_id, 'social_profiles__slack_id': soc_prof2.slack_id, 'user_chats__penny_chat__id': user1.id, 'user_chats__penny_chat__date': penny_chat1.date, 'user_chats__penny_chat__title': penny_chat1.title, 'user_chats__penny_chat__follow_ups__user_id': user2.id, 'user_chats__penny_chat__follow_ups__user__first_name': user2.first_name},  # noqa
        {'id': user2.id, 'first_name': user2.first_name, 'social_profiles__slack_team_id': soc_prof2.slack_team_id, 'social_profiles__slack_id': soc_prof2.slack_id, 'user_chats__penny_chat__id': user2.id, 'user_chats__penny_chat__date': penny_chat2.date, 'user_chats__penny_chat__title': penny_chat2.title, 'user_chats__penny_chat__follow_ups__user_id': user2.id, 'user_chats__penny_chat__follow_ups__user__first_name': user2.first_name},  # noqa
